      ...
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        <div className="text-xl font-extrabold flex flex-row gap-2 items-center">
          ...
          <div className="flex flex-row gap-2 items-center">  
            <input type="text" placeholder="Session Token" value={sessionToken || ""} onChange={(e) => setSessionToken(e.target.value)} />
            <input type="text" placeholder="Gym ID" value={gymId || ""} onChange={(e) => setGymId(e.target.value)} />
          </div>
        </div>
          {isLoading ? (
